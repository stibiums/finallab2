...
SELECTED_RUNS = [
    ...
    "baseline_random1_seed77",
    "baseline_random1_seed78",
    "baseline_unident_s",
    ...
    "small_corridor_subtask_router_jitter_bc_delivery_alt_holder",
    "small_corridor_subtask_router_jitter_bc_delivery_ego_holder",
    "small_corridor_subtask_router_best_bc_ppo_delivery_alt_holder",
    "small_corridor_subtask_router_best_bc_ppo_delivery_ego_holder",
    ...
    "partner_conditioned_random1_six_partners_holdout78",
]
