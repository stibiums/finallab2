...
| random1 partner-id conditioned | `configs/partner_conditioned_random1_four_partners.json` | Append partner id one-hot to ego observation; improves four-known-partner average to 2.34 soups and minimum to 0.80, but unknown seed76 remains 0 under fixed and inferred ids |
