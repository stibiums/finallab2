...
| `partner_conditioned_random1_four_partners` | 5.60 with copied first partner | 0.80 to 1.70 with weaker known partners; 0.00 with unknown seed76 | Partner-id conditioning improves known-partner avg/min, but does not generalize to the unseen seed76 probe. |
