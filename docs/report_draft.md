...
| `partner_conditioned_random1_four_partners` | 5.60 with copied first partner | 0.80 to 1.70 with weaker known partners; 0.00 with unknown seed76 | 显式 partner id 条件化提升已知 partner avg/min，但不泛化到未知 seed76。 |
